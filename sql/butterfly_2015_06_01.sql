...
INSERT INTO `module` VALUES ('23', '防伪码上传', 'manage_code.php?action=validate_list', '21', '0', null, '2015-05-31 23:52:56');
...
CREATE TABLE `product` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `no` (`no`)
) ENGINE=InnoDB AUTO_INCREMENT=14703 DEFAULT CHARSET=utf8;
...
CREATE TABLE `validate_code` (
  ...
  `state` enum('0','1','2','3','99') DEFAULT '99',
  `is_delete` enum('0','1') DEFAULT '0',
  `first_query_date` timestamp NULL DEFAULT NULL,
  `second_query_date` timestamp NULL DEFAULT NULL,
  `third_query_date` timestamp NULL DEFAULT NULL,
  `create_date` timestamp NULL DEFAULT NULL,
  `update_date` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
